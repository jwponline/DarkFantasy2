...
public class TempMain {
	public static NPC main(){//HttpSession s){
		...
		String Initial = ("You find yourself among the ruins of an ancient library, the books have long since gone to dust, but there are still sign of habitation. \nYou advance slowly and silently, in the distance you hear some footsteps approaching, one of which sounds very heavy."
